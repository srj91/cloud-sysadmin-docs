...
Send-MailMessage -BodyAsHtml -SmtpServer smtp.office365.com -Port 587 -UseSsl -From noreply@example.com -To suraj.chopade@aptean.com -Subject 'CRITICAL - MHW01 Memory Usage' -Body $body -Credential $credential
