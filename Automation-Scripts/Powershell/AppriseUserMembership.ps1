$Report = @()
#Collect all users
$Users = Get-ADUser -Filter * -Properties Name, GivenName, SurName, SamAccountName, EmailAddress, UserPrincipalName, MemberOf, Enabled -ResultSetSize $Null
...
$Out | Add-Member -MemberType noteproperty -Name Mail -Value $User.EmailAddress
...
$Report | Sort-Object Name | Export-Csv -Path ‘C:\usersmember.csv’ -NoTypeInformation
